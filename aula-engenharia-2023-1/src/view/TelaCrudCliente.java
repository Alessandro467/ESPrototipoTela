...
public class TelaCrudCliente extends JInternalFrame {
	...
	public TelaCrudCliente() {
		...
		painelCampos.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Consulta de Animal", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblSenha = new JLabel("Dono:");
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Cachorro", "Gato", "Pássaro", "Iguana"}));
