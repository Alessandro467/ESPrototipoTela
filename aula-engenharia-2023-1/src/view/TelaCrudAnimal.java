...
public class TelaCrudAnimal extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaCrudAnimal frame = new TelaCrudAnimal();
	...
	public TelaCrudAnimal() {
		...
		painelCampos.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Consulta de Cliente", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblLogin = new JLabel("Código:");
		...
		JLabel lblSenha = new JLabel("Nome do Animal:");
		...
		JLabel lblCategoria = new JLabel("Telefone:");
		lblCategoria.setBounds(10, 128, 90, 14);
		painelCampos.add(lblCategoria);
		
		textField = new JTextField();
		textField.setColumns(10);
		textField.setBounds(92, 126, 197, 20);
